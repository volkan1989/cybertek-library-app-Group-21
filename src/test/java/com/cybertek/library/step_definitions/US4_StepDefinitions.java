...
public class US4_StepDefinitions extends US4_LocatorsBase {
    ...
    public void user_select_in_status(String string)throws Exception {
        status.sendKeys(string);
    ...
    public void user_select_in_start_date(String string) throws Exception{
    ...
    public void user_write_to_address(String string)throws Exception {
        Thread.sleep(1000);
        address.clear();
        Thread.sleep(1000);
